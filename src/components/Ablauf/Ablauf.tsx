  ...
  return (
    <section className="AblaufSection">
      ...
      <div className="AblaufFakten">
        <div className="AblaufFaktenGroup">
          <h3>Get together</h3>
          <div className="Fact">
